import svgPaths from "./svg-enzxodotql";
...
export default function FlagSelection() {
  return (
    <div className="bg-white relative size-full" data-name="Flag Selection">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[19px] items-center px-[16px] py-[13px] relative size-full">
          <div className="content-stretch flex flex-col gap-[3px] items-center relative shrink-0" data-name="Selected Language">
            <Frame />
